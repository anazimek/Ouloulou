...
class AdsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'town_id' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'created' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        'modified' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        'ads_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'picture_url' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'fk_user_id' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_type_ad_id' => ['type' => 'index', 'columns' => ['type_ad_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'town_id' => 'Lorem ipsum dolor sit amet',
            'created' => '2016-10-10 14:53:55',
            'modified' => '2016-10-10 14:53:55',
            'ads_name' => 'Lorem ipsum dolor sit amet',
